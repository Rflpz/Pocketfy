...
- (void)setupView {
  ...
  self.imagePickerView.backgroundColor = [self colorFromHexString:@"#2c3e50"];
...
- (void)imagePickerViewSetup {
  ...
  [self.collectionView setBackgroundColor:[self colorFromHexString:@"#2c3e50"]];
  ...
  UIFont *btnFont = [UIFont fontWithName:@"Roboto-Light" size:19.0];
  
  self.photoLibraryBtn = [[UIButton alloc] initWithFrame:libraryBtnFrame];
  [self.photoLibraryBtn setTitle:@"BIBLIOTECA DE FOTOS" forState:UIControlStateNormal];
  ...
  [self.cameraBtn setTitle:@"TOMAR FOTO" forState:UIControlStateNormal];
  ...
  for (UIButton *btn in @[self.photoLibraryBtn, self.cameraBtn, self.cancelBtn]) {
    [btn setTitleColor:[self colorFromHexString:@"#1abc9c"] forState:UIControlStateNormal];
    [btn setTitleColor:[self colorFromHexString:@"#ecf0f1"]  forState:UIControlStateHighlighted];
  }
    
  
  UIView *separator1 = [[UIView alloc] initWithFrame:CGRectMake(0, 140, screenWidth, 1)];
  separator1.backgroundColor = [self colorFromHexString:@"#ecf0f1"];
  ...
  separator2.backgroundColor = [self colorFromHexString:@"#ecf0f1"];
  ...
  separator3.backgroundColor = [self colorFromHexString:@"#ecf0f1"];
